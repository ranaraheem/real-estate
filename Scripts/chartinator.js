...
; (function ($, window, document, Math, undefined) {
    ...
    var chartinator = function (el, options) {
        ...
        o.setupChart = function ( ) {
            ...
            if ( o.options.chartOptions ) { // Use chartOptions object if it Exist
        ...
        o.collectData = function () {
            ...
            if ( o.options.columns ) {
                if (dataArray[0] && dataArray[0][0] && dataArray[0][0].label) { // header data Exist
                ...
                } else { // header data does not Exist
            ...
            if (  o.options.rows && dataArray.length ) { // js data array Exist
                if ( o.options.colIndexes ) { // colIndexes array Exist
